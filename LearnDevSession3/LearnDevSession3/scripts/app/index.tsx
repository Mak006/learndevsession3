...
let friends: Friends.Friends = ReactDOM.render(<Friends.Friends initialData={friendsData} />, document.getElementById("friendsNode")) as Friends.Friends;
friends.getData();

ReactDOM.render(<Profile />, document.getElementById("profileNode"));

let coursesData: Items.IItemProps[] = [
    {
        "id": 1,
...
let articlesData: Items.IItemProps[] = [
    {
        "id": 1,
...
let coursesComponent: Items.Items = ReactDOM.render(<Items.Items />, document.getElementById("coursesNode")) as Items.Items;
let articlesComponent: Items.Items = ReactDOM.render(<Items.Items />, document.getElementById("articlesNode")) as Items.Items;
